...
STORMFIN_OBJS = StormFin.o RunGNC.o MockData.o Controller.o DataStore.o KalmanFilter.o ComplementaryFilter.o Utilities.o GSLWrappers.o Sensors.o Thrusters.o LaminarModel.o Collocation.o
